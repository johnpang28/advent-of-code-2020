...
import me.jp.aoc.Day12.Ship
import me.jp.aoc.Day12.Ship2
import me.jp.aoc.Day12.doInstruction
import me.jp.aoc.Day12.input
...
object Day12 {
    ...
    data class Ship(val x: Int = 0, val y: Int = 0, val bearing: Int = 90)
    ...
    private fun convertF(bearing: Int, value: Int): Instruction = when((bearing % 360).absoluteValue) {
        0 -> Instruction('N', value)
    ...
    val input: List<Instruction> = """
        ...
        R90
        F36
    """.trimIndent().lines().map { Instruction(it.first(), it.drop(1).toInt()) }
}